...
from psd2.evaluation.testing import flatten_results_dict
from psd2.solver import LRMultiplier
from psd2.utils.events import EventStorage, EventWriter
...
class PeriodicCheckpointer(_PeriodicCheckpointer, HookBase):
    """
    Same as :class:`psd2.checkpoint.PeriodicCheckpointer`, but as a hook.
...
class TorchProfiler(HookBase):
    ...
    def after_step(self):
        ...
        if "://" not in out_file:
            ...
            with tempfile.TemporaryDirectory(prefix="psd2_profiler") as d:
...
class EvalHook(HookBase):
    ...
    def after_train(self):
        ...
        # NOTE remove to avoid eval after relaunch when the training has already finished
        if self.trainer.iter + 1 >= self.trainer.max_iter:
            self._do_eval()
