...
from psd2.utils import comm, env

from .wrappers import BatchNorm2d, BatchNorm1d
...
class FrozenBatchNorm1d(FrozenBatchNorm2d):
    ...
    def __repr__(self):
        return "FrozenBatchNorm1d(num_features={}, eps={})".format(
            self.num_features, self.eps
        )
...
def get_norm1d(norm, out_channels):
    """
    Args:
        norm (str or callable): either one of BN, SyncBN, FrozenBN, GN;
            or a callable that takes a channel number and returns
