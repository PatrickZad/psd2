                                ...
                                "annotations": [
                                    {
                                        ...
                                        "descriptions": imgorgid_to_text["{}_{}}".format(infos[-1] + ".jpg",pid)]
                                    }
                                ],
                            }
                        }
...
def _load_subset_full_anno(dataset_dir, subset_name):
    ...
    with tqdm(total=len(sub_img_fns)) as pbar:
        for img_fn in sub_img_fns:
            ...
            texts=[imgorgid_to_text["{}_{}".format(img_name,orgid)] if orgid>0 else ["A person with unknown identity."] for orgid in ids] # more like description padding for unlabeled person
