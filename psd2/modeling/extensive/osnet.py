...
class OSNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.conv1 = Conv2d(
            ...
            stride=2,
            padding=3,
            norm=get_norm("IN" if IN else "BN", channels[0]),
            activation=torch.nn.ReLU(inplace=True),
        )  # ConvLayer(3, channels[0], 7, stride=2, padding=3, IN=IN), NOTE instance norm is not supported yet
    ...
    @classmethod
    def _make_layer(
        cls, block, layer, in_channels, out_channels, reduce_spatial_size, IN=False
    ):
        layers = []
