...
class SearchBaseTBPS(nn.Module):
    @configurable
    def __init__(self, size_div,pix_mean, pix_std, vis_period):
    ...
    def from_config(cls, cfg):
        return {
            "size_div": cfg.INPUT.SIZE_DIVISIBILITY,
    ...
    def preprocess_input(self, input_list):
        ...
        for in_dict in input_list:
            ...
            images.append(image)
        images = ImageList.from_tensors(images, self.size_div)
        return images
