...
from psd2.layers import ShapeSpec, nonzero_tuple, batched_nms
from psd2.structures import Boxes, ImageList, Instances, pairwise_iou
from psd2.utils.events import get_event_storage
from psd2.utils.registry import Registry

from ..backbone.resnet import BottleneckBlock, ResNet, BasicBlock
...
class Res5ROIHeads(ROIHeads):
    ...
    def _build_res5_block(cls, cfg):
        ...
        # fmt: on
        if cfg.MODEL.RESNETS.DEPTH == 34:  # NOTE resnet18 is not supported for now
